...
export default function AdminEmailAutomations() {
    ...
    return (
        <div className="flow-builder-v4">
            <style>{`
                .flow-builder-v4 { position: fixed; inset: 0; background: #f4f6f8; z-index: 9999; display: flex; flex-direction: column; font-family: "Inter Tight", Roboto, Arial, sans-serif; color: #1a1c1d; }
            ...
            {showDesigner && (
                <div className="designer-overlay">
                    <style>{`
                        .modal-designer-root { 
                            width: 100vw; height: 100vh; background: #f1f5f9; display: flex; flex-direction: column; font-family: "Inter Tight", Roboto, Arial, sans-serif;
                        }
                        .modal-header {
