      ...
      <style>{`
        ...
        *::after {
        ...
        .ed-admin-content :where(
          ...
          border-radius: var(--ed-radius-sm) !important;
          transition-duration: var(--ed-motion-instant) !important;
        }
        ...
        .ed-admin-content :where(.ed-billing-search, .ed-search-field, .search-pill):focus-within {
          outline: 2px solid var(--ed-color-text-inverse) !important;
          outline-offset: 2px !important;
          border-color: var(--ed-color-text-inverse) !important;
          box-shadow: none !important;
        ...
        .ed-admin-content :where(
          .ed-button-primary,
          button[type="submit"].ed-button-primary,
          a.ed-button-primary,
          .btn-save,
          .btn-shopify-primary,
          .btn-save-indigo,
        ...
        .ed-admin-content :where(.ed-danger, .alert-error, .btn-danger, .label-no) {
          color: var(--ed-color-danger) !important;
          border-color: var(--ed-color-danger) !important;
        }

        .ed-admin-content :where(.ed-warning) {
          color: var(--ed-color-warning) !important;
        }

        .ed-admin-content :where(svg[color="#43b9b2"], svg[color="#82b440"], svg[color="#008060"]) {
          color: var(--ed-color-text-inverse) !important;
