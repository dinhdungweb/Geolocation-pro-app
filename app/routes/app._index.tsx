  ...
  return (
    <Page fullWidth>
      ...
      <style>{`
        ...
        .geo-map-viewport.is-dragging .geo-map-canvas {
          transition: none;
        }
        .geo-map-controls {
          position: absolute;
        ...
        .geo-map-control:last-child {
          border-right: 0;
        }
        .geo-map-control:hover:not(:disabled) {
        ...
        .geo-map-control:disabled {
          color: var(--p-color-text-disabled, #b5b5b5);
          cursor: default;
        }
        .geo-map-control-reset {
          font-size: 16px;
        }
        .geo-map-zoom-level {
          position: absolute;
