...
<div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; border: 1px solid #e1e1e1; border-radius: 8px; overflow: hidden;">
    <div style="background-color: #008060; padding: 20px; text-align: center;">
        <h1 style="color: white; margin: 0;">Welcome to GeoPro!</h1>
    </div>
    <div style="padding: 30px; line-height: 1.6; color: #333;">
        <p>Hi there,</p>
        <p>Thank you for installing <strong>Geolocation Redirect Pro</strong>! We're excited to help you provide a localized experience for your international customers.</p>
        <p>With GeoPro, you can:</p>
        <ul>
        ...
        <div style="text-align: center; margin: 30px 0;">
            <a href="https://${shop}/admin/apps/geolocation-redirect-pro" style="background-color: #008060; color: white; padding: 12px 24px; text-decoration: none; border-radius: 5px; font-weight: bold;">Go to Dashboard</a>
        </div>
    ...
    <div style="background-color: #f9f9f9; padding: 15px; text-align: center; font-size: 12px; color: #777;">
        &copy; 2024 GeoPro Geolocation Redirect. All rights reserved.
    </div>
</div>
`;
...
<div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; border: 1px solid #ffcc00; border-radius: 8px; overflow: hidden;">
    ...
    <div style="padding: 30px; line-height: 1.6; color: #333;">
        <p>Hi there,</p>
        <p>Your shop <strong>${shop}</strong> has reached <strong>80%</strong> of its monthly visitor limit.</p>
        ...
        <div style="text-align: center; margin: 30px 0;">
            <a href="https://${shop}/admin/apps/geolocation-redirect-pro/app/pricing" style="background-color: #ffc107; color: #000; padding: 12px 24px; text-decoration: none; border-radius: 5px; font-weight: bold;">Upgrade Plan</a>
        </div>
        <p>Best regards,<br>The GeoPro Team</p>
    </div>
</div>
...
<div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; border: 1px solid #dc3545; border-radius: 8px; overflow: hidden;">
    ...
    <div style="padding: 30px; line-height: 1.6; color: #333;">
        <p>Hi there,</p>
        <p>Your shop <strong>${shop}</strong> has reached or exceeded <strong>100%</strong> of its monthly visitor limit.</p>
        <div style="background: #f8f9fa; padding: 15px; border-radius: 5px; margin: 20px 0;">
            <p style="margin: 5px 0;">Current Usage: <strong>${usage.toLocaleString()}</strong> visitors</p>
            <p style="margin: 5px 0;">Plan Limit: <strong>${limit.toLocaleString()}</strong> visitors</p>
        </div>
        ...
        <div style="text-align: center; margin: 30px 0;">
            <a href="https://${shop}/admin/apps/geolocation-redirect-pro/app/pricing" style="background-color: #dc3545; color: white; padding: 12px 24px; text-decoration: none; border-radius: 5px; font-weight: bold;">Upgrade Now</a>
        </div>
        <p>Best regards,<br>The GeoPro Team</p>
    </div>
</div>
